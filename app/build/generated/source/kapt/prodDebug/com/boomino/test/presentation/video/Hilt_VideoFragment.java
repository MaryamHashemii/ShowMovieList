...
public abstract class Hilt_VideoFragment<T extends ViewDataBinding> extends ObserverDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideoFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoFragment_GeneratedInjector) this.generatedComponent()).injectVideoFragment(UnsafeCasts.<VideoFragment>unsafeCast(this));
    }
  }
