...
public abstract class Hilt_FragmentVideoDetail<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentVideoDetail(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentVideoDetail_GeneratedInjector) this.generatedComponent()).injectFragmentVideoDetail(UnsafeCasts.<FragmentVideoDetail>unsafeCast(this));
    }
  }
